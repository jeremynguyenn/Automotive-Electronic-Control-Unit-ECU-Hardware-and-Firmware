...
void Injector_SchedulePulse(uint8_t cylinder_index, float pulse_width_ms) {
    ...
    // Configure timer/channel based on cylinder
    switch (cylinder_index) {
        ...
        case 2: // Injector 3
            // Set auto-reload register
            TIM1->ARR = pulse_ticks + 20;
            // Set compare register for channel 3 (fixed typo from original CCR1)
        ...
        case 3: // Injector 4
            // Set auto-reload register
            TIM1->ARR = pulse_ticks + 20;
            // Set compare register for channel 4 (fixed typo from original CCR2)
